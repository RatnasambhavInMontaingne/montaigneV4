const memberDetails = [
    {
        ...
        details: 'Rohith Sampathi is a management consultant, free-lance writer, business marketer and an automotive enthusiast. During his journey with market intelligence industry, he was extensively working on research modelling for animal nutrition, automotive and machinery industries. Further, having worked as the Marketing Lead for a market research firm in the highly competitive paid marketing arena, his expertise in marketing for a diverse user-base is notable.',
        social: [
            {
                icon: 'Li',
    ...
    },
    {
        ...
        designation: 'Product Specialist',
        details: 'Innovates, creates and perfects every product that Montaigne comes across. A gamer after  work,a music person and reads books once a while. The bio might look a little too normal but you’ve gotta be here to witness his specialities.',
        social: [
            // {
            //     icon: 'Github',
